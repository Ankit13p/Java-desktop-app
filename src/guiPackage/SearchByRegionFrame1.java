...
import java.awt.event.ActionListener;
	...
	public class SearchByRegionFrame1 extends JFrame {
		...
		public void regionSearch() throws HeadlessException {
			try
			{
			Read rd = new Read();
			rd.readData();
			...
			for(int i1=0; i1<al.size();i1++) {
						...
						if (((String) row[2]).contains(textField_1.getText())) {
		 ...
		 */
		public SearchByRegionFrame1() throws FileNotFoundException, IOException {
			setTitle("NZSociety");
			...
			JLabel lblSortByRegion = new JLabel("Search By Region");
			...
			textField_1.setToolTipText("Start with Capital");
