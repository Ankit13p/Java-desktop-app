...
public class SortByRegionFrame1 extends JFrame {
	...
	public void setTable() throws FileNotFoundException, IOException {
		...
		ArrayList<NzSocietyData> nzdArrayList=SortMain.regionSort();
	 ...
	 */
	public SortByRegionFrame1() throws FileNotFoundException, IOException {
		setTitle("NZSociety");
		...
		JLabel lblSortByRegion = new JLabel("Sort By Region");
